...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA1     ------> ADC1_IN2
    */
    HAL_GPIO_DeInit(GPIOC, MSV_ADC_Pin|R_ADC_Pin|G_ADC_Pin|B_ADC_Pin);

    HAL_GPIO_DeInit(GPIOA, B_SHT_P_Pin|B_SHT_N_Pin);
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    PB15     ------> ADC2_IN15
    */
    HAL_GPIO_DeInit(GPIOA, BSV_ADC_Pin|G_SHT_P_Pin);

    HAL_GPIO_DeInit(GPIOC, G_SHT_N_Pin|GSV_ADC_Pin);

    HAL_GPIO_DeInit(GPIOB, RSV_ADC_Pin|R_SHT_P_Pin|R_SHT_N_Pin);
